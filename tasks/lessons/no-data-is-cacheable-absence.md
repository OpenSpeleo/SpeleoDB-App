...
A successful provider response whose content is a recognized no-data sentinel
is not equivalent to an HTTP error. Treating both as failures prevents finite
sync jobs from completing and repeatedly downloads an answer the client has
already verified.
