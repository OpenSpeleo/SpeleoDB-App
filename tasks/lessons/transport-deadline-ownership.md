...
Never classify an abort as a malformed response. Broad parse-error handling
must re-check cancellation before returning a fallback body. Native transports
that cannot cancel underlying work must race it with the deadline, consume its
