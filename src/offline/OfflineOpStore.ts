 ...
 * IndexedDB object store, so a force-quit or crash mid-sync can only ever lose
 * the single op being mutated -- never the whole queue. Records survive app
 * shutdown, crash, and phone restart (IndexedDB is on-disk).
 *
