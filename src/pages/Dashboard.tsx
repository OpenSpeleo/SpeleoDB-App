...
/** Bounds enclosing a set of recorded GPS points, or null when none are valid. */
function boundsFromPoints(points: readonly RecordedPoint[]): LngLatBoundsLike | null {
  let minLng = Infinity;
  let maxLng = -Infinity;
  let minLat = Infinity;
  let maxLat = -Infinity;
